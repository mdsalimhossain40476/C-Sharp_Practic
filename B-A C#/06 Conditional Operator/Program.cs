            ...
            if(!(number < 18 && number>20))
            {
                WriteLine("Reverse the result, returns False if the result is true");
                        ...
                        /*
                            ...
                            একটি সংক্ষেপ আছে, যা টারনারি অপারেটর হিসেবে পরিচিত কারণ এটি তিনটি অপারেন্ডে গঠিত। এটি একাধিক লাইনের কোডকে একটি লাইনে প্রতিস্থাপন করতে ব্যবহার করা যেতে পারে। এটি প্রায়ই সহজ If...Else স্টেটমেন্ট প্রতিস্থাপন করতে ব্যবহার করা হয়
